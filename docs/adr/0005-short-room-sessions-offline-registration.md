...
ARKit tracking is accurate to about 1-3 cm inside a room but drifts: a benchmark of four VIO systems measured about 0.02 m/s relative pose error for ARKit (Sensors 2022, https://pmc.ncbi.nlm.nih.gov/articles/PMC9785098/), a corridor test found about 1.5 m of error after 19.1 m, and an indoor mapping study reports up to 12 cm residuals at longer ranges (https://www.sciencedirect.com/science/article/pii/S2666165923000510). A whole-house walk therefore ends tens of centimetres to more than a metre off.

Thermal and storage limits point the same way: LiDAR, camera and mesh at 30 fps heat the phone (Apple keeps RoomPlan sessions under about 5 minutes), and a session writes about 800 MB per 5 minutes. One long session also puts a whole visit at risk from a single crash.
