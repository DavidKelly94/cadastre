...
```
pipeline/
  pyproject.toml            [project] name = "cadastre"; [project.scripts] cadastre = "cadastre.cli:main"
  cadastre/
    __init__.py
...
Project store (default `./cadastre-data`, override with `--store`):
