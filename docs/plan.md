...
> - The product is named **Cadastre**, with the bundle identifier `com.davidkelly.cadastre`
>   ([ADR-0019](adr/0019-name-cadastre.md)). Identifiers below carry the new name; the decision
>   table does not.
