...
///
/// Anything here that the pipeline also relies on comes from `VividHomeCore` or
/// from `docs/session-format.md`, not from a literal typed twice.
enum AppConfig {
  static let productName = "VividHome"
  ...
  /// `VH-000` to `VH-059`, matching the generated sheet and `docs/markers.md`.
